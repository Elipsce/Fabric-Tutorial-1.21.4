package net.elipsce.tutorialmod.screen.custom;
...
public class PedestalScreen extends HandledScreen<PedestalScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, GUI_TEXTURE, x, y, 0f, 0f, backgroundWidth, backgroundHeight, 256, 256);
    }
